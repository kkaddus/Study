...
function fnCodeCheck(){
	fnModalOpen("url", "primary", "300", "160", "11000", "중복코드 검색", "/adm/ath/cde/viewCdeMasterCheck.do", "");
}
...
function fnInsert(){
	...
	if(valCheck){
		...
		$.ajax({
			type : "POST",
			url : "/adm/ath/cde/insertCodeMasterJson.do",
			dataType : "json",
			data : paramData,
				...
				<td>
					<div class="form-inline" style="text-align: left;">
                         <div class="input-group input-group-sm">
							<input type="text" size="20" maxlength="10" disabled id="codeId" name="codeId" class="form-control input-sm validationCheck" >
