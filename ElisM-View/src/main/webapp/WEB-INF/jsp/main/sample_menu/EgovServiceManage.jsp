...
<!-- login status start -->
<div id="login_area"><c:import url="/main/UonPageLink.do?link=main/inc/EgovIncTborder" /></div>
<!-- //login status end -->
<!-- wrap start -->
<div id="wrap"> 
    <!-- header start -->
    <div id="subheader"><c:import url="/main/UonMainMenuHead.do" /></div>   
    <!-- //header end -->
    <!--  타이틀 이미지 시작 -->
    ...
    <!-- footer 시작 -->
    <div id="footer"><c:import url="/main/UonPageLink.do?link=main/inc/EgovIncFooter" /></div>
    <!-- //footer 끝 -->
</div>
<!-- //wrap end -->
</body>
