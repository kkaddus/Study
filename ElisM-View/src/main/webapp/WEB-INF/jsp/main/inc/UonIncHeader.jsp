...
<div class="login_area_loc">
	...
	<div class="loginbg02">
        ...
        <ul>
            ...
            <li>|</li>
            <li><a href="<c:url value='/cmn/lgn/loginOut.do'/>">로그아웃</a></li>
        </ul>
        <% } %>
	</div>
		<div class="loginbg03"></div>
</div>
<h1><a href="<c:url value='/'/>main/mainPage.do">템플릿 로고</a>
</h1>
<a href="<c:url value='/main/UonPageLink.do?link=main/sample_menu/Intro'/>" target="_blank"><img width="20" height="20" src="<c:url value='/images/question.jpg'/>" alt="메뉴구성 설명" title="메뉴구성 설명"></a>
...
<script type="text/javascript">
    ...
    function goMenuPage(menuNo){
        ...
        document.menuListForm.action = "<c:url value='/main/UonPageLink.do'/>";
